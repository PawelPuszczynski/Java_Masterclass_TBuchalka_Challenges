...
//                    e.printStackTrace();
    ...
    public boolean transfer(BankAccount destinationAccount, double amount) throws InterruptedException {
        if (withdraw(amount)) {
...
class Transfer implements Runnable {
    ...
    public void run() {
        while (true) {
            try {
                if (!!sourceAccount.transfer(destinationAccount, amount)) break;
            } catch (InterruptedException e) {
                e.printStackTrace();
            }
            continue;
