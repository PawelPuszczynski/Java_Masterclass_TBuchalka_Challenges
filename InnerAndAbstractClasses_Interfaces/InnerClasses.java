...
//INNER CLASS - SongList ***************************************************************************
    public class SongList {
        ...
        public void pickSongsToPlaylist() {
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ipod ipod = new Ipod();
        Ipod.SongList songList = ipod.new SongList();
        ...
        songList.addToAlbumList(album);
        songList.addToAlbumList(album1);
        songList.pickSongsToPlaylist();
